...
async def _list_tools() -> List[types.Tool]:
    ...
    return [
        types.Tool(
            name="say_hello",
            title="Say Hello",
            description="Display a personalized hello world greeting with an optional name",
            inputSchema={
                "type": "object",
                "properties": {
                    "name": {
    ...
    if tool_name == "say_hello":
        ...
        return types.CallToolResult(
            content=[
                types.TextContent(
                    type="text",
                    text=f"{greeting} This is a simple hello world app. Interact with the component below.",
                )
            ],
            structuredContent={
                "greeting": greeting,
